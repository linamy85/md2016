...
# start of _main_
# python predlink.py $(directory) $(loop_num) $(famousN) $(mult) $(output_file)
if __name__ == '__main__':

    directory               = sys.argv[1]
    loop_num                = int(sys.argv[2])
    theta, eta              = 0.0000001, 0.000000001
    famousN, mult           = int(sys.argv[3]), int(sys.argv[4])
    node_file               = 'node.txt'
    ...
    print('Ouput to file', output_file, ': done'  )
